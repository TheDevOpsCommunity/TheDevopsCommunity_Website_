  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <ul className="list-disc list-inside mb-4">
        <li>Name</li>
        <li>Email address</li>
        <li>Payment information (for course and webinar purchases)</li>
        <li>Information you provide when you contact us for support</li>
        <li>Usage data related to your interaction with our courses and webinars</li>
      </ul>
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>Process your transactions for course and webinar enrollments</li>
