...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    ...
    >
      <div className="px-8">
        <h4 className="text-3xl lg:text-5xl lg:leading-tight mt-10 max-w-5xl mx-auto text-center tracking-tight font-medium text-black">
          Featured Courses
        </h4>

        <p className="text-sm lg:text-base max-w-2xl my-4 mx-auto text-neutral-500 text-center font-normal">
          Comprehensive training programs designed to launch your DevOps career
        </p>
      </div>
